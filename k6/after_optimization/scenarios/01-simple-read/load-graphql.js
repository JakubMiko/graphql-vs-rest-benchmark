// k6/after_optimization/scenarios/01-simple-read/load-graphql.js
// Scenario 1: Simple Read - GraphQL Load Test (OPTIMIZED PHASE)
// Fetch single user by ID - simplest possible operation with NO nested relations
//
// NOTE: This query doesn't use pagination/caching optimizations since it's a single record lookup.
// Included for consistency with baseline phase testing.
//
...
export function setup() {
  console.log('Starting Scenario 1: Simple Read - GraphQL Load Test (OPTIMIZED)');
  console.log('Testing: publicUser query (no auth, no nested relations)');
  console.log('Note: No pagination/caching for single record queries');
...
export function teardown(data) {
  console.log('Scenario 1 (GraphQL OPTIMIZED) completed');
}
