// k6/after_optimization/scenarios/04-write-operations/load-rest.js
// Scenario 4: Write Operations - REST Load Test (OPTIMIZED PHASE)
// Test event creation performance via REST POST endpoint
//
// NOTE: Write operations don't benefit from read caching optimizations.
// This test is included for completeness and to measure mutation performance.
//
...
export function setup() {
  console.log('Starting Scenario 4: Write Operations - REST Load Test (OPTIMIZED)');
  ...
  if (loginResponse.status === 200) {
    ...
    if (token) {
      ...
      console.log('Note: Write operations do not benefit from read caching');
...
export function teardown(data) {
  console.log('Scenario 4 (REST OPTIMIZED) completed');
